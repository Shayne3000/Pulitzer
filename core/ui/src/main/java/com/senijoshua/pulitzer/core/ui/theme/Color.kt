 ...
 * Light theme colors
 */
// toolbar and button background
val md_theme_light_primary = Color(0xFFB62226)
// text on toolbar and button background
...
val md_theme_light_surfaceTint = Color(0xFFB62226)
